...
class FerloadImportSpec extends FlatSpec with Matchers with BeforeAndAfterEach with TestContainerForAll {
  ...
  val expectedOutput = Seq(
    DrsObjectSpec(),
    DrsObjectSpec(id = "doc2", size = Some(3555072L), name = Some("S14358.cram.crai"), mime_type = Some("CRAI"), uris = List("s3://cqdg-qa-file-import/jmichaud/study1/dataset_data1/1002/S14358.cram.crai"), scopes = Some(List("STUDY1_data2", "STUDY1"))),
  )
