...
lazy val root = (project in file("."))
  .settings(
    ...
    libraryDependencies += "org.keycloak" % "keycloak-adapter-core" % "23.0.4" % Test,
    libraryDependencies += "org.keycloak" % "keycloak-core" % "23.0.4" % Test,
    libraryDependencies += "org.keycloak" % "keycloak-admin-client" % "23.0.4" % Test,
